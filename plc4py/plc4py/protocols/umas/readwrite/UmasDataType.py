...
class UmasDataType(Enum):
    ...
    def __new__(cls, value, data_type_conversion, request_size, data_type_size):
        obj = object.__new__(cls)
        obj._value_ = value
        obj.data_type_conversion = data_type_conversion
        obj.request_size = request_size
        obj.data_type_size = data_type_size
        return obj
